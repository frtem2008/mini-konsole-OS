...
public class LipovskyGame extends JFrame implements KeyListener, MouseInputListener {
...
//  for (int i = 0; i < COUNT_ZOMBIE; i++) {}
    ...
    public static void run() throws InterruptedException {
        LipovskyGame jf = new LipovskyGame();
        jf.setSize(w, h);//размер экрана
        jf.setUndecorated(false);//показать заголовок окна
        jf.setTitle("Обалденный код лосося(пиратская версия)");
